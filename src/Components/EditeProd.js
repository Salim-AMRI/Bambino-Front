  ...
  return (
    <div>
      <Icon onClick={toggle} className="edit">
        {" "}
        <img
              src="https://cdn.icon-icons.com/icons2/1946/PNG/128/1904675-configuration-edit-gear-options-preferences-setting-settings_122525.png
              "
              alt="Modifier l'article"
            />  
      </Icon>
