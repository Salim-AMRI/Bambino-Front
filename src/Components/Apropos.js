...
const Propos = () => {
  return (
    <div>
      <div>
        <h1 className="h-rez">Découvrir comment ça marche</h1>
        <h2 className="h-rez">Vendre, c’est simple !</h2>
        <div className="vente">
          <div>
            <img
        ...
        <h2 className="h-rez">Achète en toute sécurité !</h2>
        <div className="vente">
          <div>
            <img
      ...
      {/* <div>
        <h2>Tu es prêt(e) ?</h2>
        <Link to="/auto">
        <button className="re-size btnt">Commencer à acheter</button> </Link>
        <Link to="/auto">
        <button className="re-size btnt">Commencer à vendre</button></Link>
      </div> */}
      <div>
